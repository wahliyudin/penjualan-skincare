...
<body>
    ...
    <hr class="m-2">
    <hr class="m-2">
    <h3 class="text-center">Laporan Data Pelanggan</h3>
    <table>
        <tr>
            <td>Tanggal</td>
            <td>:</td>
    ...
    <table style="width: 100%; border-collapse: collapse; border: 1px solid black; margin-top: 10px;">
        <thead>
            <tr style="border: 1px solid black;">
                ...
                <th style="border: 1px solid black; text-align: center;">Alamat</th>
                <th style="border: 1px solid black; text-align: center;">Telepon</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($data as $item)
                <tr style="border: 1px solid black;">
                    ...
                    <td style="border: 1px solid black; text-align: center;">{{ $item->address }}</td>
                    <td style="border: 1px solid black; text-align: center;">{{ $item->phone_number }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
