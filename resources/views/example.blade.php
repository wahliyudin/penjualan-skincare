...
<body class="theme-blush">
    ...
    <nav class="navbar p-l-5 p-r-5">
        <ul class="nav navbar-nav navbar-left">
            ...
            <li>
                <a href="mail-inbox.html" title="Inbox">
            ...
            <div class="tab-pane stretchRight active" id="dashboard">
                <div class="menu">
                    <ul class="list">
                        ...
                        <li><a href="events.html"><i class="zmdi zmdi-calendar-check"></i><span>Events</span> </a>
                        </li>
                        ...
                        <li><a href="noticeboard.html"><i class="zmdi zmdi-alert-circle"></i><span>Noticeboard</span>
                            </a></li>
                        <li><a href="centres.html"><i class="zmdi zmdi-pin"></i><span>University Centres</span></a>
                        </li>
                        ...
                        <li>
                            <div class="user-info m-b-20 p-b-15">
                                <div class="image"><a href="profile.html"><img
                                            src="{{ asset('assets/images/profile_av.jpg') }}" alt="User"></a>
                                </div>
                                <div class="detail">
                                    <h4>Pro. Charlotte</h4>
                                    <small>Design Faculty</small>
